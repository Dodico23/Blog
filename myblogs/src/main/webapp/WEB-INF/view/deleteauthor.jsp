...
value="${authorsDelete[0].getPhone()}" />
</div>
</div>
...
<div class="col-sm-6">
<input type="text" class="form-control" name="dataregistration"
value="${authorsDelete[0].getDataRegistration()}" />
</div>
</div>

<button type="submit" class="btn btn-primary">Удалить</button>
<a href='<c:url value="author" />' role="button"
