...
<h3>Редактирование Комментария</h3>
    <div class="container" id="container-form">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" readonly
                           value="${commentDelete[0].getId()}" />
                </div>
            </div>

            <div class="row mb-3">
                <label for="visitDate" class="col-sm-2 col-form-label">Комментарий</label>
                <div class="col-sm-10">
                    <input type="text" name="content" class="form-control" id="staticContent"
                           value="${commentDelete[0].getContent()}" />
                </div>
            </div>

            <div class="row mb-3">
                <label for="visitLength" class="col-sm-2 col-form-label">Дата комментария</label>
                <div class="col-sm-10">
                    <input type="text" name="datecomment" class="form-control" id="staticDateComment"
                           value="${commentDelete[0].getDateComment()}" />
                </div>
            </div>

           <div class="row mb-3">
                <label for="visitor" class="col-sm-2 col-form-label">Автор</label>
                <div class="col-sm-10">
		...
		<c:forEach var="author" items="${authors}">
            ...
            <div class="row mb-3">
                <label for="visitor" class="col-sm-2 col-form-label">Пост</label>
                <div class="col-sm-10">
